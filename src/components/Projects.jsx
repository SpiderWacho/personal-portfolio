...
const Projects = forwardRef( function Projects(props, ref) {
  ...
  const projectsObj = [{
          ...
          "description" : `${language === 'english' ? `The objective of this project was to put in practice all the things
          that i learned about Node.js and Express applications. I also used MongoDB and the MVC model.` : `El objetivo de este proyecto era poner en practica todas las cosas que aprendi sobre Node.js y aplicaciones Express. Tambien use MongoDB para la base de datos, EJS y el modelo MVC.`}`,
            "preview" : crudPreview,                                                                                                               
            "inverted": false,
            "aos": "fade-left",
            "redirectPreview" : 'https://game-store.fly.dev/catalog',
