...
function Project({image, title, description, preview, inverted, aos, redirectPreview, redirectCode}) {
            ...
            <div className='project' data-aos={aos} data-aos-duration="1000">
              <div className={'project-left ' + (inverted === true ? "inverted ": "" )}>
                ...
                <div className='project-button-container'>
                    <button type='button' className='project-button' onClick={() => {redirect(redirectPreview)}}>{language === 'english' ? 'Live Preview' : 'Demo'}</button>
                    <button type='button' className='project-button' onClick={() => {redirect(redirectCode)}}>{language === 'english' ? 'View Code' : 'Codigo'}</button>
                </div>
             </div>
