    ...
    switch (game) {
      case 'tictactoe':
        ...
        setDescription(
          `${
            language === 'english'
              ? `In this project the idea was to apply the things
      ...
      case 'battleship':
        ...
        setDescription(
          `${
            language === 'english'
              ? `The goal of this project was to apply the lessons learned about TDD (Test Driven Development). 
      ...
      case 'memory':
        ...
        setDescription(
          `${
            language === 'english'
              ? `This project was my first approach to React.js,
      ...
      case 'sketch':
        setUrl(
          'https://htmlpreview.github.io/?https://github.com/SpiderWacho/etch_a_sketch/blob/main/index.html'
        );
        setTitle(`${language === 'english' ? 'ETCH A SKETCH' : 'DIBUJA ALGO'}`);
        setDescription(
          `${
            language === 'english'
              ? `The idea behind this little project was
      ...
      case 'rock':
        setUrl(
          'https://htmlpreview.github.io/?https://github.com/SpiderWacho/rock_paper_scisors/blob/main/index.html'
        );
        ...
        setDescription(
          `${
            language === 'english'
              ...
              : `Este fue mi primer proyecto para aprender Javascript.`
          }`
        );
        break;
      default:
    ...
    <>
      <Layout>
        <div className="gamezone-content">
          <h2 className="gamezone-title">
            {language === 'english' ? 'Play Ground' : 'Zona de Juegos'}
          </h2>
          <div className="game-container">
            <iframe className="game" src={url} title="game"></iframe>
          ...
          <div className="project-selector">
            <div className="preview-container">
              <img
                ...
                src={tictactoe}
                alt="An screenshot of an tictactoe game"
                onClick={() => selectGame('tictactoe')}></img>
            </div>
            <div className="preview-container">
              <img
                className="preview-img"
                src={memory}
                alt="An screenshot of an card game"
                onClick={() => selectGame('memory')}></img>
            </div>
            <div className="preview-container">
              <img
                className="preview-img"
                src={sketch}
                alt="An screenshot of a page to draw in a grid"
                onClick={() => selectGame('sketch')}></img>
            </div>
            <div className="preview-container">
              <img
                className="preview-img"
                src={rock}
                alt="An screenshot of an rock, paper, scissors game"
                onClick={() => selectGame('rock')}></img>
            </div>
          </div>
        </div>
      </Layout>
